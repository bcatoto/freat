...
class AttendingModel(db.Model):
    ...
    user_id = db.Column(db.String(20), db.ForeignKey('users.netid', ondelete="CASCADE"), nullable = False)
    post_id = db.Column(db.Integer, db.ForeignKey('postings.id', ondelete="CASCADE"), nullable = False)
