...
$input-focus-box-shadow: 0 0 0 rgba(0, 0, 0, 0);
...
$custom-file-focus-box-shadow: 0 0 0 rgba(0, 0, 0, 0);
$custom-select-focus-border-color: 0 0 0 rgba(0, 0, 0, 0);
$custom-file-focus-border-color: 0 0 0 rgba(0, 0, 0, 0);
$custom-control-indicator-focus-box-shadow: 0 0 0 rgba(0, 0, 0, 0);
$custom-control-indicator-focus-border-color: 0 0 0 rgba(0, 0, 0, 0);
$pagination-focus-box-shadow: 0 0 0 rgba(0, 0, 0, 0);
$custom-control-indicator-box-shadow: 0 0 0 rgba(0, 0, 0, 0);
