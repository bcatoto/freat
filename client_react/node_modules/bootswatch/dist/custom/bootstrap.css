...
.btn-secondary {
  ...
  .btn-secondary:focus, .btn-secondary.focus {
    box-shadow: 0 0 0 0 rgba(165, 179, 179, 0.5); }
...
.btn-success {
  ...
  .btn-success:focus, .btn-success.focus {
    box-shadow: 0 0 0 0 rgba(59, 198, 171, 0.5); }
...
.btn-light {
  ...
  .btn-light:focus, .btn-light.focus {
    box-shadow: 0 0 0 0 rgba(206, 210, 211, 0.5); }
...
.btn-dark {
  ...
  .btn-dark:focus, .btn-dark.focus {
    box-shadow: 0 0 0 0 rgba(143, 156, 156, 0.5); }
...
.btn-outline-success {
  ...
  .btn-outline-success:focus, .btn-outline-success.focus {
    box-shadow: 0 0 0 0 rgba(24, 188, 156, 0.5); }
...
.btn-outline-light {
  ...
  .btn-outline-light:focus, .btn-outline-light.focus {
    box-shadow: 0 0 0 0 rgba(236, 240, 241, 0.5); }
...
.btn-outline-dark {
  ...
  .btn-outline-dark:focus, .btn-outline-dark.focus {
    box-shadow: 0 0 0 0 rgba(123, 138, 139, 0.5); }
...
.custom-control-input {
  ...
  .custom-control-input:focus:not(:checked) ~ .custom-control-label::before {
    border-color: 0 0 0 rgba(0, 0, 0, 0); }
